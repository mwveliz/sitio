...
use MAT\SitioBundle\Entity\FosGroup;
use MAT\SitioBundle\Form\FosGroupType;
...
class FosGroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fosGroups = $em->getRepository('SitioBundle:FosGroup')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MAT\SitioBundle\Form\FosGroupType', $fosGroup);
    ...
    {
        $deleteForm = $this->createDeleteForm($fosGroup);
        $editForm = $this->createForm('MAT\SitioBundle\Form\FosGroupType', $fosGroup);
