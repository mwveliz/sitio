 ...
 * Enlace
 *
 * @ORM\Table(name="enlace", indexes={@ORM\Index(name="IDX_8414B279FCF8192D", columns={"id_usuario"})})
 * @ORM\Entity
 */
class Enlace
{
     ...
     * @ORM\SequenceGenerator(sequenceName="enlace_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
