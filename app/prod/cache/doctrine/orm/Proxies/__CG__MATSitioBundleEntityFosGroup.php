 ...
 */
class FosGroup extends \MAT\SitioBundle\Entity\FosGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\FosGroup' . "\0" . 'name', '' . "\0" . 'MAT\\SitioBundle\\Entity\\FosGroup' . "\0" . 'roles', '' . "\0" . 'MAT\\SitioBundle\\Entity\\FosGroup' . "\0" . 'id', '' . "\0" . 'MAT\\SitioBundle\\Entity\\FosGroup' . "\0" . 'user');
        }
