 ...
 */
class Usuario extends \MAT\SitioBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'dni', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'nacionalidad', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'apellido', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'telefono', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Usuario' . "\0" . 'telefonoSecundario', 'id', 'group', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setTelefonoSecundario($telefonoSecundario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTelefonoSecundario', array($telefonoSecundario));

        return parent::setTelefonoSecundario($telefonoSecundario);
    }
    ...
    public function getTelefonoSecundario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTelefonoSecundario', array());

        return parent::getTelefonoSecundario();
    }
