 ...
 */
class Documento extends \MAT\SitioBundle\Entity\Documento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'descripcion', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'ruta', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'visible', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'fechaHora', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'id', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Documento' . "\0" . 'idTipoDocumento');
        }
