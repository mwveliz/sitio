 ...
 */
class TipoDocumento extends \MAT\SitioBundle\Entity\TipoDocumento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\TipoDocumento' . "\0" . 'descripcion', '' . "\0" . 'MAT\\SitioBundle\\Entity\\TipoDocumento' . "\0" . 'id');
        }
