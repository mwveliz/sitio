 ...
 */
class Imagen extends \MAT\SitioBundle\Entity\Imagen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'descripcion', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'fechaHora', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'visible', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'ruta', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'autor', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'id', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Imagen' . "\0" . 'idUsuario');
        }
