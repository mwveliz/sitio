 ...
 */
class Informacion extends \MAT\SitioBundle\Entity\Informacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Informacion' . "\0" . 'descripcion', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Informacion' . "\0" . 'fechaHora', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Informacion' . "\0" . 'visible', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Informacion' . "\0" . 'id', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Informacion' . "\0" . 'idUsuario');
        }
