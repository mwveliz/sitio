 ...
 */
class Estadistica extends \MAT\SitioBundle\Entity\Estadistica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'descripcion', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'fechaHora', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'visible', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'titulo', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'autor', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'ruta', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'id', '' . "\0" . 'MAT\\SitioBundle\\Entity\\Estadistica' . "\0" . 'idUsuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Estadistica $proxy) {
