...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '172.16.100.27', 'port' => 5432, 'dbname' => 'sitio', 'user' => 'aslugo', 'password' => 20309251, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/MAT/SitioBundle/Resources/config/doctrine') => 'MAT\\SitioBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'MAT\\SitioBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('SitioBundle' => 'MAT\\SitioBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1363b38b5901120dd6e04d4327c3e794e6f26aacb2be8820190b656e4d6a8ac9');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MAT\\SitioBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('MAT\\SitioBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.object_manager'), 'MAT\\SitioBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MAT\\SitioBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MAT\\SitioBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MAT\\SitioBundle\\Entity\\Usuario');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.object_manager'), 'MAT\\SitioBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'America/Caracas', true);
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api/' => array('allow_origin' => true, 'allow_headers' => array(0 => 'x-custom-auth'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600), '^/' => array('origin_regex' => true, 'allow_origin' => array(0 => '^http://localhost:[0-9]+'), 'allow_headers' => array(0 => 'x-custom-auth'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600, 'hosts' => array(0 => '^api\\.'))), array('allow_origin' => true, 'allow_credentials' => false, 'allow_headers' => true, 'expose_headers' => array(0 => '*'), 'allow_methods' => array(0 => '*'), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api');
        ...
        $m->add($l, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_PRUEBA', 2 => 'ROLE_USER'), NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MAT/SitioBundle/Resources/views'), 'Sitio');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SitioBundle' => 'MAT\\SitioBundle\\SitioBundle',
            ...
            'database_host' => '172.16.100.27',
            'database_port' => 5432,
            'database_name' => 'sitio',
            'database_user' => 'aslugo',
            'database_password' => 20309251,
            ...
            'fos_user.model.user.class' => 'MAT\\SitioBundle\\Entity\\Usuario',
            ...
            'fos_user.model.group.class' => 'MAT\\SitioBundle\\Entity\\Group',
            ...
            'stfalcon_tinymce.config' => array(
                ...
                'theme' => array(
                    ...
                    'advanced' => array(
                        'plugins' => array(
                            0 => 'advlist autolink lists link image jbimages charmap print preview hr anchor pagebreak',
